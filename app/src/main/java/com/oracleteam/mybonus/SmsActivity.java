...
public class SmsActivity extends AppCompatActivity {
    ...
    protected String jsonSMS;
    protected String jsonBarcode;
    protected String jsonPhone;

    //from MainActivity (Login page)
    protected String ph;
    protected String bc;
...
//        }
        ...
        protected String doInBackground(Void... params) {
            ...
            link = "http://web-service.gdv.name/api/validateuser.php?" + type + ph;
...
//        Toast.makeText(this, "you have clicked smsValidate", Toast.LENGTH_LONG).show();
        ...
        EditText smsText = findViewById(R.id.smsText);

        String sms = smsText.getText().toString();


        Log.d(LOG_TAG, "jsonSMS " + jsonSMS);
        Log.d(LOG_TAG, "sms " + sms);



        if(sms.equals(jsonSMS)){
            Toast.makeText(this, "sms == jsonSMS", Toast.LENGTH_LONG).show();
            ...
            //data
            cv.put("barcode", jsonBarcode);
            cv.put("phone1", "0997855542");
            cv.put("name", "UASIA");
            cv.put("last_name", "some last name");
            cv.put("amount", 100500);
            cv.put("discount", 27);

            //try to INSERT SOME shit
            db.insert("aid_user", null, cv);
            ...
            Toast.makeText(this, "YOU ARE VASYAN", Toast.LENGTH_LONG).show();
        }
